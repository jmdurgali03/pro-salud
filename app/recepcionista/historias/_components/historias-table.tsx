...
export function HistoriasTable({
    pacientes,
    onView,
    searchTerm,
    isLoading = false,
                                ...
                                <tr key={paciente._id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 align-top">
                                        <div className="flex flex-wrap gap-2">
                                            {Array.isArray(paciente.obrasSocialesNombres) &&
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        <ActionsMenu onView={() => onView(paciente._id)} />
                                    </td>
                                </tr>
                            ))
                        ) : (
                ...
                <div
                    ...
                    style={{
                        top: (() => {
                            ...
                            const menuHeight = 44; // altura aproximada del menú (1 item)
