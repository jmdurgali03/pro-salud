...
export function HistoriasSearchBar({
    value,
    onChange,
    isLoading = false,
    obrasSociales,
        ...
        <div className="flex flex-col sm:flex-row gap-3 relative">
            <div className="flex-1 relative">
                ...
                <input
                    ...
                    disabled={isLoading}
                    className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all disabled:bg-gray-50 disabled:cursor-not-allowed text-sm"
                />
            </div>
            ...
            <div className="relative" ref={filterRef}>
                ...
                >
                    ...
                    <span className="text-sm text-gray-700">
                        Obras Sociales
                        {selectedCount > 0 && (
                            <span className="ml-1.5 px-2 py-0.5 bg-green-500 text-white text-xs rounded-full">
                                {selectedCount}
                            </span>
                        )}
                    </span>
